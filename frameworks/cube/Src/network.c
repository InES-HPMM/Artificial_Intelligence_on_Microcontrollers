...
#define AI_NETWORK_MODEL_SIGNATURE     "e2661049775117109fc0bad05be09848"
...
#define AI_TOOLS_DATE_TIME   "Wed Jan 15 13:39:43 2020"
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0, AI_SHAPE_INIT(4, 1, 32, 28, 2), AI_STRIDE_INIT(4, 4, 4, 128, 3584),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0, AI_SHAPE_INIT(4, 6272, 10, 1, 1), AI_STRIDE_INIT(4, 1, 3136, 31360, 31360),
...
AI_TENSOR_OBJ_DECLARE(
  ...
  0x0, 0x0, AI_SHAPE_INIT(4, 1, 6272, 1, 1), AI_STRIDE_INIT(4, 4, 4, 25088, 25088),
  1, &conv2d_output_array, NULL)
AI_TENSOR_OBJ_DECLARE(
...
AI_NETWORK_OBJ_DECLARE(
  ...
  AI_TENSOR_LIST_IO_ENTRY(AI_FLAG_NONE, AI_NETWORK_OUT_NUM, &dense_nl_output),
  &conv2d_layer, 0, NULL)
  ...
  ai_network* net_ctx, const ai_buffer* activation_buffer)
{
...

  {
    ...
    conv2d_output_array.data = AI_PTR(activations + 7168);
    conv2d_output_array.data_start = AI_PTR(activations + 7168);
  ...
  ai_network* net_ctx, const ai_buffer* weights_buffer)
{
...

  {
    ...
    dense_bias_array.data = AI_PTR(weights + 32704);
    dense_bias_array.data_start = AI_PTR(weights + 32704);
    dense_weights_array.format |= AI_FMT_FLAG_CONST;
    dense_weights_array.data = AI_PTR(weights + 1344);
    dense_weights_array.data_start = AI_PTR(weights + 1280);
